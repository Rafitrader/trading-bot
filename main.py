...
# Render Web Service কে খুশি করার জন্য একটি ডামী পোর্ট বা ওয়েবসাইট সার্ভার
...
if __name__ == '__main__':
    # ডামী সার্ভার ব্যাকগ্রাউন্ডে চালু করা যেন Render পোর্ট খুঁজে পায়
    Thread(target=run_dummy_server, daemon=True).start()
    # আসল ট্রেডিং বট চালু করা
